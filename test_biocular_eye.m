...
for i=1:10
    for j = 1:10
        intersectionInLeftEyeInitReferrenceFrame = [i*0.1-0.5; j*0.1-0.5; 1];
...
%% 测试根据视轴反向求解眼球姿态的结果
i=25;
drawEyeAndCameraSystemWithParameters(ax, leftEyePositionInGlobalReferrenceFrame, leftEyeInitReferrenceFrameToGlobalReferrenceFrame, leftKappaCalibrationVecterInLeftEyeFrame, ...
...
drawEyeAndCameraSystemWithParameters(ax, rightEyePositionInGlobalReferrenceFrame, rightEyeInitReferrenceFrameToGlobalReferrenceFrame, rightKappaCalibrationVecterInRightEyeFrame, ...
